...
function bodyLoaded(revisit)
{
   ...
   g_context.fillText("使用键盘方向键移动, 按Z发射",300,360);
   g_context.fillText("按P暂停",300,380);

   if ( g_highScore != undefined )
   {
      g_context.fillText("最高分: " + g_highScore, 370, 30);
   }
   ...
   g_context.fillText("触屏控制",425,300);
...
function itemLoaded(item)
{
   ...
   else if (item.id == "loading")
   {
      ...
      g_context.fillText("正在加载音频", 400,320);
