...
function ev_mousedown(ev)
{
   ...
   if (g_gameState == "splash")
   {
      ...
      else if ( x > 50 && x < 200 && y > 340 && y < 370 )
      {
         ...
         g_context.fillText("星际大战来了，现在是时候",60,100);
         g_context.fillText("反击他们，并且用武力争夺星球",60,125);
         g_context.fillText("这不意味着他们会放弃攻打",60,150);
         g_context.fillStyle = "white";
         g_context.fillText("使用键盘方向键移动",60,285);
         g_context.fillText("按Z进行火力压制",60,310);
         g_context.fillText("*注意在途中收集道具",60,335);
         g_context.fillText("按P暂停游戏",60,365);
         g_context.fillText("如果你使用触摸屏，请勾选[触屏控制]",60,390);
...
function ev_mousemove(ev)
{
   ...
   if ( x > 50 && x < 200 && y > 300 && y < 330 )
   {
      ...
      g_context.fillStyle = "white";
      g_context.fillText("开始游戏",73,322);
   ...
   if ( x > 50 && x < 200 && y > 340 && y < 370 )
   {
      ...
      g_context.fillStyle = "white";
      g_context.fillText("操作指南",52,361);
   }
   else
   {
      g_context.fillStyle = "black";
