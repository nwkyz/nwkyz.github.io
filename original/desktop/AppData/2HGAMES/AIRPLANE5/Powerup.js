...
Powerup.prototype.applyEffect = function()
{
   ...
   if (this.myName == "speed")
   {
      ...
      var f = new FloatyText("速度加成", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "gun")
   {
      ...
      var f = new FloatyText("激光加成", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "shot")
   {
      ...
      var f = new FloatyText("+1发", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "double")
   {
      ...
      var f = new FloatyText("双重加成", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "artifact_chard")
   {
      ...
      var f = new FloatyText("外星格莱弗 +5000", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "artifact_skull")
   {
      ...
      var f = new FloatyText("外星首领 +10000", textX, textY);
      g_floatyText.push(f);
   }
