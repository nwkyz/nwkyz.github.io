...
window.Win10 = {
    ...
    _init:function () {
        ...
        setInterval(function () {
            ...
            $("#win10_btn_time").html(hours+':'+mins+':'+secs+'<br/>'+year+'/'+month+'/'+date+'-'+day);
        },1000);
        //离开前警告
        ...
        Win10.setContextMenu('#win10>.desktop',[
            ['<i class="fa fa-fw fa-star"></i> 收藏本页',function () {
                ...
                if (ua.indexOf("360se") > -1) {
                    layer.alert(Win10.lang(':( Something went wrong.','Something went wrong'));
                }
            ...
            '|',
            ['<i class="fa fa-fw fa-info-circle"></i> '+Win10.lang('关于','About OSYZ'),function () {Win10.aboutUs()}],
        ]);
    ...
    aboutUs: function() {
        ...
        layer.open({
            ...
            title: 'YZNetwork with '+this._version,
            shadeClose: true, //开启遮罩关闭
            area: ['320px', '200px'], //宽高
            content: '<div style="padding: 10px;font-size: 12px;">' +
            '<p>Based on 2-OS Web Designer</p>' +
            '<p>©OSYZ, ExhYZ 2019-2022</p>' +
			'<p>webDisplayContainerOs Core by OSYZ' +
            '<p>[wDCOVersion 25.0.2.1010]</p>' +
            '</div>'
        });
    },
